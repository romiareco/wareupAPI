...
class ServiceModel extends Model {
  ...
  static loadInitialData() { 
    ...
    super.findOrCreate({where: { title: 'Techada' }, defaults: {title: 'Techada', description: null, serviceGroupId:1, order: 1, status: 1} });
    //super.create({title: 'Techada', description: null, serviceGroupId:1, order: 1, status: 1}); 
    super.findOrCreate({where: { title: 'Descubierta' }, defaults: {title: 'Descubierta', description: null, serviceGroupId:1, order: 2, status: 1} });
