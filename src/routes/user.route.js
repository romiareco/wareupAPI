...
router.put("/users/:id", [mdAuth.validateAuth], (req, res) => controller.update(req, res));
router.delete("/users/:id", [mdAuth.validateAuth], (req, res) => controller.delete(req, res));
router.post("/users/recover-password", (req, res) => controller.recoverPassword(req, res));
router.post("/users/update-password", (req, res) => controller.updatePassword(req, res));
