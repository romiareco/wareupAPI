...
router.put("/deposits/:id",/*[mdAuth.validateAuth], */ (req, res) => controller.update(req, res));
router.delete("/deposits/:id",/*[mdAuth.validateAuth], */ (req, res) => controller.delete(req, res));
router.post("/deposits/images/:id", /*[mdAuth.validateAuth], */(req, res) => controller.registerImages(req, res));
